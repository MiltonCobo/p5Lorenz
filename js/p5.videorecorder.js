...
/*  
this.input = input --> set input(input) {stream=captureStream(canvas)} -->createRecorder {}  recorder = MediaRecorder(stream, type)}-->
    this.#recorder.onstop = () => this.#createBlob();
    this.#recorder.ondataavailable = (e) => this.#chunks.push(e.data);
The recorder is setup after instanciating videoRecorder.

recorder.start and recorder.stop are called from outside
*/
